...
# === 1. 加载相机内参和畸变参数 ===
mtx = np.array([
    [916.23382537, 0., 272.10794038],
    [0, 922.82165266, 291.93808449],
    [0, 0, 1]
])
dist = np.array([[-5.22939783e-01, 1.29398415e+00, -9.93014716e-03, -4.94579517e-05, -3.33594103e+00]])

# === 2. 设置棋盘格信息（9x6，格子大小5mm）===
grid_x, grid_y = 9, 6
square_size = 0.005  # 5mm
